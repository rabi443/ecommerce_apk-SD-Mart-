...
import 'FoodCheckoutDeliveryScreen/FoodCheckoutDeliveryScreen.dart';
      ...
      child: SafeArea(
        child: Column(
          ...
          children: [
            ...
            _summaryRow("Delivery Charge", "Rs. 0", isTotal: false),
            const SizedBox(height: 16),
            _summaryRow("Total Amount", "Rs. ${subtotal.toStringAsFixed(0)}", isTotal: true, primaryColor: primaryColor),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  // Mapping data for the API (PascalCase will be handled in Service)
                  ...
                  // Navigating to Map/Delivery Location Screen before final API call
                  Get.to(() => FoodCheckoutDeliveryScreen(
